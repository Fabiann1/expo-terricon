...
function SignPage() {
    ...
    async function submit(e) {
        e.preventDefault();
        const rec = await register({first_name : f_name, last_name : l_name, password : password, email : email});
        if (rec.status){
  ...
  return (
    <View style={style.container}>
            ...
            <View style={style.login}>
              <Text style={style.h1}>Регистрация</Text>
              <TextInput style={style.textInput} placeholder='Имя' onChangeText={(e) => {setFirstName(e)}}/>
              <TextInput style={style.textInput} placeholder='Фамилия' onChangeText={(e) => {setLastName(e)}}/>
